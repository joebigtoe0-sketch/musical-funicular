function buildSystemPrompt(calendlyUrl) {
  const calendlyBookingLine = calendlyUrl
    ? `Voit varata ilmaisen 30 min kartoituspuhelun suoraan kalenteristamme.\n${calendlyUrl}`
...
Kun käyttäjä kysyy konsultoinnista, kartoituksesta, alkupuhelusta tai haluaa varata kartoituspuhelun, vastaa lyhyesti ja laita linkki omalle rivilleen (UI näyttää sen painikkeena):
"${calendlyBookingLine}"
