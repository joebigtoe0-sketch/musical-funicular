...
function getGoogleVerificationTag() {
  ...
  if (!code) return "";
  return `\n  <meta name="google-site-verification" content="${escapeAttr(code)}" />`;
}

function getFaviconTags() {
  return `${getGoogleVerificationTag()}
...
function getSeoInjection(filename, siteUrl) {
  ...
  const ogImage = `${siteUrl}/icons/og-image.png`;
  ...
  <meta property="og:image:alt" content="Sairas Media logo" />
